...
function save(res) {
    ...
    function request(num) {
      ...
      return  axios.get(`https://www.zhihu.com/api/v4/members/gao-ze-rong-69/following-questions?include=data%5B*%5D.created%2Canswer_count%2Cfollower_count%2Cauthor&offset=${num}`)
            // .then((res) => {
            //     let { data, paging } = res.data;
            //     isEnd = paging.is_end;
            //     console.log(isEnd)
